...
function __PPF_UIInspector(name) constructor {
	...
	static Draw = function(x1, y1, x2, y2, timer, alpha) {
		...
		draw_sprite_stretched(__ppf_sprPixel, 0, _x1, _y1, 1, __panel_height);
		draw_sprite(__ppf_sprDebugUIControl, 0, _x1, _y1+__panel_height*__scroll_value);
		draw_set_alpha(1);
...
function __ppf_ui_category(_title, _opened, _amount_opened=1) : __ppf_ui_element() constructor {
	...
	static Draw = function() {
		...
		draw_sprite_stretched_ext(__ppf_sprPixel, 0, xx+10, yy+text_height/2, (_width/2-text_width/2)-20, 1, _color, alpha);
		draw_sprite_stretched_ext(__ppf_sprPixel, 0, (xx+_width/2+text_width/2)+10, yy+text_height/2, (_width/2-text_width/2)-20, 1, _color, alpha);
...
function __ppf_ui_menu(_title, _opened=true, _amount_opened=1) : __ppf_ui_element() constructor {
	...
	static Draw = function() {
		...
		// draw
		draw_sprite_stretched_ext(__ppf_sprPixel, 0, xx, yy, parent.__panel_width-xx, height-8, c_black, alpha);
...
function __ppf_ui_folder(_title, _opened, _amount_opened=1) : __ppf_ui_element() constructor {
	...
	static Draw = function() {
		...
		// draw
		draw_sprite_stretched_ext(__ppf_sprPixel, 0, xx, yy, parent.__panel_width, height-4, c_black, alpha*0.8);
		draw_set_valign(fa_middle);
...
function __ppf_ui_checkbox(_title, _column=0, _checked=false, _callback=undefined) : __ppf_ui_element() constructor {
	...
	callback = _callback;
	column = _column;
	sprite = __ppf_sprDebugUICheckbox;
...
function __ppf_ui_slider(_title, _subdivisions=0, _auto_update=false, _default_value=1, _range_min=0, _range_max=1, _can_autoupdate=true, _callback=undefined) : __ppf_ui_element() constructor {
	...
	static Draw = function() {
		...
		draw_set_color(c_white);
		draw_set_alpha(alpha);
		draw_sprite_stretched(__ppf_sprPixel, 0, xx, yy+24, width, 1);
		draw_sprite(__ppf_sprDebugUIControl, 0, xx+width*value, yy+24);
		draw_text(xx, yy, text);
