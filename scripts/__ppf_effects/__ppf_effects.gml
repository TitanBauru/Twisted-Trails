...
function FX_Shake(enabled, speedd=0.25, magnitude=0.01, hspeedd=1, vspeedd=1) : __ppf_fx_super_class() constructor {
	...
	static Draw = function(renderer) {
		...
		shader_set_uniform_f(uni_magnitude, settings.speedd == 0 ? 0 : settings.magnitude);
...
function FX_LUT(enabled, intensity=1, type=1, horizontal_squares=8, texture=__spr_ppf_lut_grid_default) : __ppf_fx_super_class() constructor {
	effect_name = "lut";
	can_change_order = false;
